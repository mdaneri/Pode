@{
    ...
    certificateExpiredIntermediateExceptionMessage                    = 'El certificado {0} fue firmado por un certificado intermedio que expiró el {1}. La cadena de certificados ya no es válida.'
    ...
    certificateRevokedExceptionMessage                                = 'El certificado {0} ha sido revocado. Razón: {1}. Por favor, obtenga un nuevo certificado válido.'
    certificateSignatureInvalidExceptionMessage                       = 'El certificado {0} tiene una firma no válida. Puede haber sido alterado o no haber sido firmado por una autoridad de confianza.'
    ...
    certificateUntrustedRootExceptionMessage                          = 'El certificado {0} ha sido emitido por una autoridad raíz no confiable. Por favor, instale el certificado de la CA raíz o utilice un certificado de una autoridad confiable.'
    ...
    invalidTypeExceptionMessage                                       = 'Error: Tipo no válido para {0}. Se esperaba {1}, pero se recibió [{2}].'
    ...
    jwtAlgorithmMismatchExceptionMessage                              = 'Incompatibilidad de algoritmo JWT: Se esperaba {0}, pero se encontró {1}.'
    ...
    jwtInvalidAudienceExceptionMessage                                = 'La reclamación ''aud'' (Audience) del JWT es inválida o falta. Audiencia esperada: ''{0}''.'
    jwtInvalidIssuerExceptionMessage                                  = 'La reclamación ''iss'' (Issuer) del JWT es inválida o falta. Emisor esperado: ''{0}''.'
    jwtInvalidJtiExceptionMessage                                     = 'La reclamación ''jti'' (JWT ID) del JWT es inválida o falta. Se requiere un identificador único válido.'
    jwtInvalidSubjectExceptionMessage                                 = 'La reclamación ''sub'' (Subject) del JWT es inválida o falta. Se requiere un sujeto válido.'
    jwtIssuedInFutureExceptionMessage                                 = 'La marca de tiempo ''iat'' (Issued At) del JWT está configurada en el futuro. El token aún no es válido.'
    jwtMissingAudienceExceptionMessage                                = 'El JWT no tiene la reclamación obligatoria ''aud'' (Audience). Se requiere una audiencia válida.'
    jwtMissingIssuerExceptionMessage                                  = 'El JWT no tiene la reclamación obligatoria ''iss'' (Issuer). Se requiere un emisor válido.'
    jwtMissingJtiExceptionMessage                                     = 'El JWT no tiene la reclamación obligatoria ''jti'' (JWT ID).'
    ...
    unknownAlgorithmOrInvalidPfxExceptionMessage                      = 'Algoritmo desconocido o formato PEM no válido.'
    unknownAlgorithmWithKeySizeExceptionMessage                       = 'Algoritmo {0} desconocido (Tamaño de clave: {1} bits).'
