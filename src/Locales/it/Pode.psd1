@{
    ...
    certificateNotValidForPurposeExceptionMessage                     = 'Il certificato NON è valido per ''{0}''. Scopi trovati: {1}'
    certificateNotValidYetExceptionMessage                            = 'Il certificato {0} NON è ancora valido. Valido dal: {1} (UTC)'
    ...
    certificateUnknownEkusStrictModeExceptionMessage                  = 'Il certificato contiene EKU sconosciuti. La modalità rigorosa lo rifiuta. Trovato: {0}'
    ...
    digestTokenAuthMethodNotSupportedExceptionMessage                 = 'Digest Quality of Protection ''auth-int'' è supportato solo per i metodi HTTP PUT, POST o PATCH.'
    ...
    jwtInvalidAudienceExceptionMessage                                = 'Il claim ''aud'' (Audience) del JWT non è valido o è mancante. Pubblico previsto: ''{0}''.'
    jwtInvalidIssuerExceptionMessage                                  = 'Il claim ''iss'' (Issuer) del JWT non è valido o è mancante. Emittente previsto: ''{0}''.'
    ...
    jwtIssuedInFutureExceptionMessage                                 = 'Il timestamp ''iat'' (Issued At) del JWT è impostato nel futuro. Il token non è ancora valido.'
    jwtMissingAudienceExceptionMessage                                = 'Il JWT non ha il claim obbligatorio ''aud'' (Audience). È richiesto un pubblico valido.'
    jwtMissingIssuerExceptionMessage                                  = 'Il JWT non ha il claim obbligatorio ''iss'' (Issuer). È richiesto un emittente valido.'
    ...
    loggerDoesNotExistExceptionMessage                                = 'Il logger ''{0}'' non esiste.'
    ...
    pemCertificateNotSupportedByPwshVersionExceptionMessage           = 'Il formato del certificato PEM non è supportato in PowerShell {0}. Utilizzare un formato di certificato diverso o eseguire l''aggiornamento a PowerShell 7.0 o versioni successive.'
    ...
    deprecatedFunctionWarningMessage                                  = 'ATTENZIONE: La funzione ''{0}'' è obsoleta e verrà rimossa nelle versioni future. Si prega di utilizzare invece la funzione ''{1}''.'
